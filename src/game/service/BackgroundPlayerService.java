...
public class BackgroundPlayerService implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            //TODO - 1
            //플레이어 왼쪽 하단 기점 RGB색상 추출
            int bottomLeft = image.getRGB(player.getX() + 5, player.getY() + 55);
            //플레이어 오른쪽 하단 기점 RGB색상 추출
            int bottomRight = image.getRGB(player.getX() + 50, player.getY() + 55);
            //바닥/ 층 좌표 감지
            if (bottomLeft + bottomRight == -2) {
                //허공  아직 점프 낙하 중이 아닐떄만 낙하시작
...
//        return color.getRed() == 0 && color.getGreen() == 0 && color.getBlue() == 255;
//    }


//    public boolean isRed(int x, int y) {
//            Color Color = new Color(image.getRGB(x + 5, y + 25));
//            return isRed(Color);
//    }
}
